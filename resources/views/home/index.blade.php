  ...
  <div class="container">
      ...
      <div class="row heading-row">
          <div class="col-md-12 text-center">
              <span class="subheading">Produk Herbal Immunie Store</span>
              ...
              <div class="product-item hover-trigger">
                  <div class="product-img">
                      <a href="/front/shop-single.html">
                        <img style="width=100%; height:250px;" src="/uploads/{{$product->gambar}}" alt="">
                      </a>
        ...
        <div class="container relative">
          ...
          <div class="row heading-row mb-20">
            <div class="col-md-6 col-md-offset-3 text-center">
              <h2 class="heading white bottom-line">Testimoni Pembeli</h2>
            </div>
          </div>
