...
<script>
    $(function(){
        $('.add-to-cart').click(function(e){
            e.preventDefault(); // Mencegah tindakan default dari tombol klik

            @auth('webmember') {{-- Mengecek apakah pengguna terautentikasi sebagai member --}}
            ...
            @else
                window.location.href = '/'; // Jika tidak terautentikasi, arahkan kembali ke halaman home
            @endauth
        })
    })
    $(document).ready(function() {
        $('.add-to-cart').click(function(e) {
            ...
            @auth('webmember')
                // Pengguna terautentikasi, lanjutkan dengan proses penambahan ke keranjang
                id_member = {{Auth::guard('webmember')->user()->id}};
                id_barang = {{$product->id}};
                jumlah = $('.jumlah').val();
                size = $('#size').text();
